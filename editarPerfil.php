...
if (isset($_GET['validate'])) {
	...
	if (empty($datos['error'])) {
		...
		if ($res) {//Modificacion correcta
			...
			sendAjaxData(array('msg' => "Se ha realizado modificación de perfil correctamente.", 'url' => "index.php"));
	...
	sendAjaxData(array('msg' => "No está logueado.Debe loguearse para editar su perfil.", 'url' => "index.php"), 400);
